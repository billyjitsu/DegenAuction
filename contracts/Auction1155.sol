...
import "./NFT1155Escrow.sol";

contract Auction1155 is NFT1155Escrow, Ownable {
    ...
    function startAuction(address _contractAddress, uint256 tokenId, uint256 _amount) public {
        auctionStarted = true;
        auctionStartTime = block.timestamp;
        auctionEndTime = (auctionStartTime + 3 minutes) ;  //base in minutes, day = 1440 minutes, 1 week = 10080
        registerAuction(_contractAddress, tokenId, _amount); 
